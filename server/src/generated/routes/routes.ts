...
import { Configurationontroller } from '../../controllers/configuration';
import { ImgController } from '../../controllers/img';
import { MediaItemController } from '../../controllers/item';
import { ItemsController } from '../../controllers/items';
import { MetadataProviderCredentialsControler } from '../../controllers/metadataProviderCredentials';
...
const _Configurationontroller = new Configurationontroller();
...
const _MetadataProviderCredentialsControler =
    new MetadataProviderCredentialsControler();
...
router.patch(
    ...
    _Configurationontroller.update
);
router.get(
    '/api/configuration',
    validatorHandler({}),
    _Configurationontroller.get
);
router.get(
    '/img/poster',
    validatorHandler({
...
router.get(
    ...
    validatorHandler({}),
    _MetadataProviderCredentialsControler.get
);
router.put(
    '/api/metadata-provider-credentials',
    validatorHandler({
    ...
    _MetadataProviderCredentialsControler.set
);
router.put(
    '/api/rating',
    validatorHandler({
