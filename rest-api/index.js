...
class Api extends HttpClient {
    constructor() {
        ...
        this.user = {
             ...
             * @secure
             */
            getNotificationCredentials: (params = {}) =>
                this.request({
             ...
             * @secure
             */
            updateNotificationCredentials: (data, params = {}) =>
                this.request({
                    path: `/api/user/notification-credentials`,
                    method: 'PUT',
                    body: data,
